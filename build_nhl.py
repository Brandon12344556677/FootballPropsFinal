...
def write_weekly(picks):
    """Most recent week that has graded LIVE Value picks -> nhl_weekly.json, for the
    ...
    try:
        ...
        with open("nhl_weekly.json", "w", encoding="utf-8") as f:
            json.dump(out, f, separators=(",", ":"), ensure_ascii=False)
        print(f"  nhl_weekly.json: Week {week} value {out['hit']}/{out['n']} {out['units']:+}u")
    except Exception as e:
        print(f"  nhl_weekly.json: skipped ({e})")
